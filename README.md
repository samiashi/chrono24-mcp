...
| `find_deals`      | The one-call answer to "find me a good deal on X": full-range price stats (up to 3 requests), then the listings at or below market p25 with `pctBelowMedian` and caution flags for too-good-to-be-true prices.                                                                                                                      |
